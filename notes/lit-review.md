# Literature Review: Mediated, Hidden Power and the Case for the Personal Platform
...
1. **Marx**, *Capital* Vol. I, **ch. 1 only** (Fowkes, Penguin 1976), esp. §4.
2. **McLuhan**, *Understanding Media* (1964), Part 1 (chs. 1–7); skim Part 2. (Or the whole *Medium Is the Massage* in an afternoon.)
3. **Debord**, *Society of the Spectacle* (Knabb) — start at ch. 4 if ch. 1 is too dense, then chs. 1–3.
4. **Foucault**, *Discipline and Punish* — the "Panopticism" chapter is core; Parts 3–4 ideally.
5. **Latour**, "Where Are the Missing Masses?" (1992) + "Mixing Humans and Nonhumans Together" (Johnson, 1988) — ~50 pp.
6. **Deleuze**, "Postscript on the Societies of Control" — five pages; read three times.
7. **Han**, *Psychopolitics*, then *The Burnout Society*.
