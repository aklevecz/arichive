<script>
	...
	onMount(() => {
		...
		const groups = [
			...
			{ selector: '.anim-btn-ar path', baseDelay: 700 },
			{ selector: '.anim-btn-ai path', baseDelay: 900 },
			{ selector: '.anim-btn-yaytso path', baseDelay: 1100 },
			{ selector: '.anim-beaker path', baseDelay: 1400 }
		];
	...
	function navigateTo(destination) {
		if (destination === 'ai' || destination === 'ar') {
			goto(`/${destination}`);
			return;
		}
		filter.resetFilters();
...
<div class="homepage" bind:this={container}>
	...
	<svg class="design-svg desktop-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 906.11 541.93">
		...
		<a class="anim-btn-yaytso btn-link" href="https://yaytso.art" target="_blank" rel="noopener" aria-label="Visit yaytso.art">
			<path d="M455.6,466.8c1.6,7.4,4.3,14.6,8,21.4"/>
			<path d="M480.1,465.4c-1.4,11.6-4.8,22.9-9.9,33.4-2.3,4.7-5.7,9.6-10.9,10.2"/>
			<path d="M506.9,470.8c-5.1-3.2-12.4-1.6-15.5,3.6-3.1,5.2-1.5,12.5,3.4,15.7,4.2,2.8,10.4,1.7,13.5-2.4"/>
			<path d="M507.4,468.1c-1.1,7.4-.4,15,2,22.1"/>
			<path d="M517.2,466.4c1.1,7.7,4.2,15.1,9.1,21.4"/>
			<path d="M541.9,465.9c-1.9,11.5-5.3,22.7-10.1,33.3-2.2,4.8-5.5,9.7-10.6,10.3"/>
			<path d="M556.1,455.2c-1.2,11-.5,22.2,1.9,33,.4,1.8,2.1,3.8,3.9,3.1"/>
			<path d="M548.9,468.9c5-1,10.1-1.5,15.2-1.4"/>
			<path d="M588.4,473.6c-2.6-3.4-7.6-4.5-11.4-2.3-3.3,1.9-4.8,6.3-2.8,9.4,2.2,3.4,7.9,3,10.6,5.9,1.9,2,.5,5.5-2.5,6-2.7.4-5.4-.7-7.4-2.4"/>
			<path d="M607.1,469.4c-5.8-.4-11.2,4.1-12,9.8-.8,5.7,3,11.5,8.5,13,5,1.3,10.6-1.7,12.4-6.6,1.8-5.2-.8-11.4-5.6-13.9-1.1-.6-2.4-1-3.6-1.1"/>
			<rect class="click-area" x="445" y="446" width="185" height="76"/>
		</a>
	...
	<svg class="design-svg mobile-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 335.96 560.68">
		...
		<a class="anim-btn-yaytso btn-link" href="https://yaytso.art" target="_blank" rel="noopener" aria-label="Visit yaytso.art" transform="translate(-369.1, -150)">
			<path d="M455.6,466.8c1.6,7.4,4.3,14.6,8,21.4"/>
			<path d="M480.1,465.4c-1.4,11.6-4.8,22.9-9.9,33.4-2.3,4.7-5.7,9.6-10.9,10.2"/>
			<path d="M506.9,470.8c-5.1-3.2-12.4-1.6-15.5,3.6-3.1,5.2-1.5,12.5,3.4,15.7,4.2,2.8,10.4,1.7,13.5-2.4"/>
			<path d="M507.4,468.1c-1.1,7.4-.4,15,2,22.1"/>
	...
	<a
		class="app-link"
		href="https://apps.apple.com/us/app/rel-app/id6768832244"
		target="_blank"
		rel="noopener"
		aria-label="Download the Rel app on the App Store"
	>
		<svg class="app-svg" xmlns="http://www.w3.org/2000/svg" viewBox="72 553 160 60">
			<path d="M100.28,569.97c-.22,8.05,0,16.11.64,24.13-3.35-2.09-6.7-4.18-10.05-6.27,3.05.34,6.2-.22,8.95-1.59" />
			<path d="M110.7,584.46l-4.85,4.1c1.91,1.33,3.65,2.92,5.14,4.71,1.38-1.47,2.62-3.07,3.7-4.77-1.54-1.37-3.08-2.75-4.63-4.12" />
			<path d="M117.24,584.25c.65,2.82,1.52,5.59,2.61,8.28.53-1.84,1.06-3.67,1.6-5.51.95,1.58,1.89,3.16,2.84,4.74.09-2.83.18-5.65.26-8.48" />
			<path d="M129.73,592.78c.07-3.27-.26-6.55-.98-9.74" />
			<path d="M129.81,586.11l4.84-2.5c-.6,2.69-.63,5.5-.09,8.2" />
			<path d="M137.98,571.08l2.54-1.85c.1,7.27.21,14.54.31,21.8.48-.54.95-1.08,1.43-1.63" />
			<path d="M149.2,582.56l-3.6,4.99c1.5,1.43,2.85,3.01,4.02,4.72.96-1.89,2.2-3.64,3.66-5.17-1.47-1.66-3.17-3.11-5.03-4.3" />
			<path d="M156.33,587.07c1.33-1.78,2.92-3.36,4.7-4.69.95,2.98,1.91,5.96,2.86,8.94-2.34-1.02-4.8-1.77-7.32-2.21,2.7-.96,5.4-1.92,8.09-2.89.55,1.39,1.1,2.78,1.65,4.17" />
			<path d="M172.51,584.25l-4.91,3.6c2.08.7,4.16,1.41,6.24,2.11-1.25-6.11-2.5-12.22-3.74-18.33" />
			<path d="M185.38,576.91c1.18,4.12,2.12,8.31,2.82,12.54" />
			<path d="M183.39,576.21c3.18,1.18,6.53,1.87,9.92,2.04-2.18,1.75-4.26,3.63-6.21,5.62,3.07,1.43,6.13,2.85,9.2,4.28" />
			<path d="M196.08,579.47c.05,2.55.37,5.1.97,7.58" />
			<path d="M195.3,579.95l5.23-.71" />
			<path d="M195.93,583.57l2.54-.3" />
			<path d="M196.64,586.9l4.12-.33" />
			<path d="M202.1,575.43c.27,3.98.68,7.96,1.23,11.92,3.15-.7,6.41-.9,9.62-.58" />
			<path d="M88.43,562.56c20.68.99,41.42,1.98,62.07.45,4.23-.31,8.44-.73,12.67-1.07,12.11-.97,24.28-1.27,36.42-.91.93.03,1.87.06,2.77.28,1.03.25,2,.72,2.94,1.21,6.23,3.21,12.14,7.04,17.63,11.4.28.23.57.46.74.78.21.41.2.89.19,1.35-.06,4.21.85,8.42,2.63,12.23.11.24.23.49.22.75-.01.32-.22.6-.41.86-2.48,3.3-4.97,6.59-7.45,9.89-.46.61-.93,1.23-1.57,1.65-1,.65-2.27.72-3.47.75-28.07.93-56.14,1.87-84.21,2.8-1.58.05-3.16.11-4.74.16-9.37.31-18.73.62-28.1.93-.63.02-1.29.04-1.87-.21-.72-.31-1.21-.99-1.69-1.62-2.62-3.48-5.84-6.52-9.46-8.94-.89-.59-1.84-1.18-2.38-2.1-.46-.78-.58-1.71-.69-2.62-.63-5.2-1.26-10.4-1.89-15.6-.04-.32-.08-.65-.02-.98.15-.82.88-1.38,1.54-1.89,3.38-2.57,6.37-5.65,8.83-9.11" />
			<rect class="app-click" x="74" y="555" width="156" height="56" />
		</svg>
	</a>
</div>
...
<style>
	...
	.app-link:hover .app-svg path,
	.app-link:focus-visible .app-svg path {
		stroke-width: 1.8;
	}
	.app-click {
		fill: transparent;
	...
	.anim-btn-yaytso:hover path,
	.anim-btn-yaytso:focus-visible path {
		stroke: #E09E00;
	}
